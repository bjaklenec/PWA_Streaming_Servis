<template>
    <main>
        ...
        <div class="Player">
            ...
            <div class="info">
                <p id="song">Kaktus</p>
                <p id="artist">Flaneur</p>
            </div>
            <div class="PlayerButtons">
                <a class="button" title="Previous Song"><i class="zmdi zmdi-skip-previous"></i></a>
...
.Player{
    ...
    padding: 2rem;
    min-height: 25rem;
    box-shadow: 0 19px 38px rgba(0, 0, 0, 0.3), 0 12px 12px rgba(0, 0, 0, 0.2);
}
.PlayerButtons{
    margin: 0 auto;
    position: relative;
